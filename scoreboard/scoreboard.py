...
if __name__ == "__main__":
    try:
        ...
        timestamps = [(base_time - delta).isoformat() for delta in time_deltas]
        user_bin_results = [
            {"user_bin": "Recycling", "result": "correct", "timestamp": timestamps[0]},  # Bottle ✅
            {"user_bin": "Garbage", "result": "incorrect", "timestamp": timestamps[1]},  # Cap ❌ (should be Recycling)
            {"user_bin": "Compost", "result": "correct", "timestamp": timestamps[2]},  # Pizza Box ✅
            {"user_bin": "Compost", "result": "correct", "timestamp": timestamps[3]},  # Banana Peel ✅
            {"user_bin": "Recycling", "result": "incorrect", "timestamp": timestamps[4]},  # Plastic Bag ❌ (should be Garbage)
            {"user_bin": "Recycling", "result": "correct", "timestamp": timestamps[5]},  # Glass Jar ✅
            {"user_bin": "Garbage", "result": "incorrect", "timestamp": timestamps[6]},  # Paper Towel ❌ (should be Compost)
            {"user_bin": "Garbage", "result": "correct", "timestamp": timestamps[7]},  # Styrofoam Cup ✅
            {"user_bin": "Recycling", "result": "correct", "timestamp": timestamps[8]},  # Aluminum Can ✅
            {"user_bin": "Garbage", "result": "incorrect", "timestamp": timestamps[9]}  # Yogurt Cup ❌ (should be Recycling)
                            ]
